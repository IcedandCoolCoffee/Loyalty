    ...
    <div id="page-content-wrapper">
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4 mb-3">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="admin_records@anniversary.php">Today's Anniversary <span class="round" id="annivcount"></span></a>
                </li>
                <!-- <li class="nav-item">
...
<script src="records_datatable2.js"></script>
