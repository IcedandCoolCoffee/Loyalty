    ...
    <div id="page-content-wrapper">
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4 mb-3">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="admin_records.php">All Records</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="admin_records2.php">5 Years</a>
                </li>
                <li class="nav-item">
                ...
                <audio id="alarmSound" src="assets/audio/kawaii.mp3"></audio> <!-- Add an alarm sound file -->
                    ...
                    // Display the current time with minutes
                    ...
                    if ((currentHour === 8 && currentMinutes === 00) || 
                        ...
                        (currentHour === 15 && currentMinutes === 00) && count > 0) {
                    ...
                    setInterval(fetchAnniversaryCount, 60000);
                    });
                    </script>
      ...
      <div class="modal-body">
            <form action="post" class="form mt-2 mb-2">
             <!-- <input type="hidden" class="form-control" id="id" name="id"> -->
                ...
                <input type="text" class="form-control" id="deptname" name="dept">
                </div>
                </div>
                ...
                <input type="text" class="form-control" id="salary" name="sal" style="text-align: right;">
                </div>
                </div>
